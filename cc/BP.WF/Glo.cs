    ...
    public class Glo
    {
        ...
        public static string UpdataCCFlowVer()
        {
            ...
            try
            {
                ...
                {
                    // 更新 SetGarde.
                    sql = "UPDATE Port_Station SET SetGarde=1 WHERE SetGarde IS NULL OR SetGarde=0";
                    BP.DA.DBAccess.RunSQL(sql);
                }
                catch
                {
                ...
                if (BP.WF.Glo.OSModel == BP.Sys.OSModel.OneMore)
                {
                    try
                    {
                        sql = "UPDATE PORT_STATION A SET A.FK_STATIONTYPE=A.STAGRADE WHERE A.FK_STATIONTYPE IS NULL";
                        BP.DA.DBAccess.RunSQL(sql);
                    }
                    catch
                    {
                ...
                //升级表单树. 2015.10.05
                BP.Sys.SysFormTree sft = new SysFormTree();
                ...
                //表单信息表.
                BP.Sys.MapDataExt mapext = new MapDataExt();
        ...
        public static void InitCH(Flow fl, Node nd, Int64 workid, Int64 fid, string title, string prvRDT,string sdt, DateTime dtNow)
        {
           ...
           // ch.Week = (int)dtNow.w;
            ...
            //Console.WriteLine("日期为:{0},\n是{1},\n是一年中的第{2}个周（以一年的第一天算第一个周，一周以周一开始）",
