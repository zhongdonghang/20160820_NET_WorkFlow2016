    ...
    public class MapDataExt : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(MapDataAttr.Url, null, "URL连接(对自定义表单有效)", true, false, 0, 500, 20, true);
                //数据源.
        ...
        {
            string url = "/WF/MapDef/CCForm/Frm.aspx?FK_MapData=" + this.No + "&UserNo=" + BP.Web.WebUser.No + "&SID=" + Web.WebUser.SID + "&AppCenterDBType=" + BP.DA.DBAccess.AppCenterDBType + "&CustomerNo="+BP.Sys.SystemConfig.CustomerNo;
        ...
        {
            string url = "/WF/MapDef/MapDef.aspx?FK_MapData=" + this.No + "&UserNo=" + BP.Web.WebUser.No + "&SID=" + Web.WebUser.SID + "&AppCenterDBType=" + BP.DA.DBAccess.AppCenterDBType + "&CustomerNo=" + BP.Sys.SystemConfig.CustomerNo;
            PubClass.WinOpen(url, 800, 650);
            return null;
        }
        /// <summary>
        ...
        {
            return "/WF/Comm/Search.aspx?s=34&FK_MapData=" + this.No + "&EnsName="+this.No;
        }
        /// <summary>
        /// 调用分析API
        /// </summary>
        ...
        {
            return "/WF/Comm/Group.aspx?s=34&FK_MapData=" + this.No + "&EnsName="+this.No;
        }
        /// <summary>
        /// 数据源管理
        /// </summary>
        ...
        {
            return "/WF/Comm/Search.aspx?s=34&FK_MapData=" + this.No + "&EnsName=BP.Sys.SFDBSrcs";
        }
        public string DoWordFrm()
        {
            return "/WF/MapDef/MapExt/WordFrm.aspx?s=34&FK_MapData=" + this.No + "&ExtType=WordFrm&RefNo=";
        }
        public string DoExcelFrm()
        {
            return "/WF/MapDef/MapExt/ExcelFrm.aspx?s=34&FK_MapData=" + this.No + "&ExtType=ExcelFrm&RefNo=";
        }
        public string DoPageLoadFull()
        {
            return "/WF/MapDef/MapExt/PageLoadFull.aspx?s=34&FK_MapData=" + this.No + "&ExtType=PageLoadFull&RefNo=";
        }
        public string DoInitScript()
        {
            return "/WF/MapDef/MapExt/InitScript.aspx?s=34&FK_MapData=" + this.No + "&ExtType=PageLoadFull&RefNo=";
        }
        /// <summary>
        /// 表单事件
        /// </summary>
        ...
        {
            return "/WF/Admin/Action.aspx?FK_MapData=" + this.No + "&T=sd&FK_Node=0";
        }
        /// <summary>
        /// 导出
        /// </summary>
        ...
        {
            return  "/WF/MapDef/MapExt/List.aspx?FK_MapData="+this.No+"&T=sd";
        }
        /// <summary>
        /// 导出表单
        /// </summary>
