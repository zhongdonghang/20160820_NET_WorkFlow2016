                ...
                if (i != 0 && fn.FrmSln !=0 )
                {
                    ...
                    if (mymdtl.RetrieveFromDBSources() == 1)
                    {
                     //   /Dtl.aspx?EnsName=DtlDemo_FJDtl396340&RefPKVal=212&IsReadonly=0&FID=0&FK_Node=8701
                        this.Response.Redirect("Dtl.aspx?EnsName=" + this.EnsName + "_" + this.FK_Node+"&RefPKVal="+this.RefPKVal+"&IsReadonly="+this.IsReadonly+"&FID="+this.FID+"&FK_Node="+this.FK_Node,
                            true);
                        return;
                    }
                }
                        ...
                        if (mdtl.IsEnableAthM)
                        {
                            if (dtl.OID >= 100)
                                this.Pub1.AddTD(
                                    ...
                                    dtl.OID + "&Ath=AthM&FK_MapData=" + mdtl.No + "&FK_Node="+this.FK_Node+"&FK_FrmAttachment=" + mdtl.No +
