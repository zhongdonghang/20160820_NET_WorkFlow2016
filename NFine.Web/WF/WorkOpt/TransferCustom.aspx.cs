...
namespace CCFlow.WF.WorkOpt
{
    ...
    public partial class TransferCustomUI : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable ccs = DBAccess.RunSQLReturnTable("SELECT wsa.FK_Node,wsa.FK_Emp,wsa.EmpName,wsa.Idx FROM WF_SelectAccper wsa WHERE wsa.AccType = 1 AND wsa.WorkID = " + WorkID);
            DataTable customs =
