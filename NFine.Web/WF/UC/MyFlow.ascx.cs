    ...
    public partial class MyFlow : BP.Web.UC.UCBase3
    {
        ...
        public void InitToolbar(bool isAskFor, string appPath)
        {
            ...
            if (btnLab.ThreadEnable)
            {
                ...
                toolbar.Add("<input type=button class=Btn value='" + btnLab.ThreadLab + "' enable=true onclick=\"WinOpen('" + ur2 + "'); \" />");
            }
            ...
            if (btnLab.HungEnable)
            {
                ...
                toolbar.Add("<input type=button class=Btn value='" + btnLab.HungLab + "' enable=true onclick=\"WinOpen('" + urlr + "'); \" />");
            ...
            if (btnLab.SearchEnable && isAskFor == false)
                toolbar.Add("<input type=button class=Btn value='" + btnLab.SearchLab + "' enable=true onclick=\"WinOpen('" + appPath + "WF/Rpt/Search.aspx?EnsName=ND" + int.Parse(this.FK_Flow) + "MyRpt&FK_Flow=" + this.FK_Flow + "&s=" + tKey + "','dsd0'); \" />");
            ...
            if (btnLab.SubFlowCtrlRole != SubFlowCtrlRole.None  )
            {
                ...
                toolbar.Add("<input type=button class=Btn value='" + btnLab.SubFlowLab + "' enable=true onclick=\"WinOpen('" + urlr3 + "'); \" />");
            }
            ...
            if (btnLab.CHEnable ==true )
            {
                ...
                toolbar.Add("<input type=button class=Btn value='" + btnLab.CHLab + "' enable=true onclick=\"WinShowModalDialog('" + urlr3 + "'); \" />");
            }
            ...
            if (btnLab.PRIEnable == true)
            {
                ...
                toolbar.Add("<input type=button class=Btn value='" + btnLab.PRILab + "' enable=true onclick=\"WinShowModalDialog('" + urlr3 + "'); \" />");
            }
            #endregion
            ...
            foreach (NodeToolbar bar in bars)
            {
                if (bar.ShowWhere == ShowWhere.Toolbar)
                {
                    ...
                    toolbar.Add("<input type=button class=Btn value='" + bar.Title + "' enable=true onclick=\"WinOpen('" + urlr3 + "'); \" />");
                }
            }
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (this.IsPostBack == false)
            {
                ...
                {
                    this.Response.Redirect("/WeiXin/MyFlow.aspx?WorkID=" + this.WorkID + "&FK_Flow=" + this.FK_Flow + "&FK_Node=" + this.FK_Node + "&FID=" + this.FID, true);
                    return;
                }
            }
            #endregion 判断权限
