            ...
            <div data-options="region:'west',split:true" style="width: 200px;">
                ...
                <div class="easyui-panel" title="报表查看" data-options="collapsible:true,border:false" style="height: auto">
                    <ul class="navlist">
                        <li>
                            <div>
                                <a href="javascript:void(0)" onclick="OpenUrlInRightFrame(this, '/WF/Rpt/Search.aspx?FK_Flow=<%=this.FK_Flow %>&RptNo=<%= this.RptNo%>')">
                                    <span>1. 查询</span></a></div>
                        </li>
                        <li>
                            <div>
                                <a href="javascript:void(0)" onclick="OpenUrlInRightFrame(this, '/WF/Rpt/SearchAdv.aspx?FK_Flow=<%=this.FK_Flow %>&RptNo=<%= this.RptNo%>')">
                                    <span>2. 高级查询</span></a></div>
                        </li>
                        <li>
                            <div>
                                <a href="javascript:void(0)" onclick="OpenUrlInRightFrame(this, '/WF/Rpt/Group.aspx?FK_Flow=<%=this.FK_Flow %>&RptNo=<%= this.RptNo%>')">
                                    <span>3. 分组分析</span></a></div>
                        </li>
                        <li>
                            <div>
                                <a href="javascript:void(0)" onclick="OpenUrlInRightFrame(this, '/WF/Rpt/D3.aspx?FK_Flow=<%=this.FK_Flow %>&RptNo=<%= this.RptNo%>')">
                                    <span>4. 交叉报表</span></a></div>
                        </li>
                        <li>
                            <div>
                                <a href="javascript:void(0)" onclick="OpenUrlInRightFrame(this, '/WF/Rpt/Contrast.aspx?FK_Flow=<%=this.FK_Flow %>&RptNo=<%= this.RptNo%>')">
