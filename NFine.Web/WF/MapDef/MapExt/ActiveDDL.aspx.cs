...
namespace CCFlow.WF.MapDef.MapExtUI
{
    public partial class ActiveDDLUI : BP.Web.WebPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                me.Retrieve(MapExtAttr.FK_MapData, this.FK_MapData, MapExtAttr.ExtType, MapExtXmlList.ActiveDDL,
                        MapExtAttr.AttrOfOper, this.RefNo);
                //if (string.IsNullOrEmpty(me.MyPK)==false)
                //{
                //    Response.Redirect("ActiveDDL.aspx?FK_MapData=" + this.FK_MapData + "&ExtType=" + this.ExtType + "&RefNo=" + this.RefNo + "&MyPK=" + me.MyPK, true);
                //    return;
                //}
            }
