    ...
    public partial class TBFullCtrlUI :  BP.Web.WebPage
    {
        ...
        public void EditAutoFull_TB()
        {
            ...
            if (me.IsExits == true)
            {
                ...
                this.Pub1.Add("<a class='easyui-linkbutton' href=\"TBFullCtrl.aspx?MyPK=" + this.MyPK + "&FK_MapData=" + this.FK_MapData + "&RefNo=" + this.RefNo + "&ExtType=" + this.ExtType + "&DoType=EditAutoJL\" >级连下拉框</a>");
                this.Pub1.AddSpace(1);
                this.Pub1.Add("<a class='easyui-linkbutton' href=\"TBFullCtrl.aspx?MyPK=" + this.MyPK + "&FK_MapData=" + this.FK_MapData + "&ExtType=" + this.ExtType + "&RefNo=" + this.RefNo + "&DoType=EditAutoFullDtl\" >填充从表</a>");
                this.Pub1.AddSpace(1);
                this.Pub1.Add("<a class='easyui-linkbutton' href=\"TBFullCtrl.aspx?MyPK=" + this.MyPK + "&FK_MapData=" + this.FK_MapData + "&ExtType=" + this.ExtType + "&RefNo=" + this.RefNo + "&DoType=EditAutoFullM2M\" >填充一对多</a>");
            }
