...
{
    public partial class PopVal : BP.Web.WebPage
    {
        ...
        {
            this.Title = "为字段[" + this.RefNo + "]设置pop返回值";

            int idx = 0;
            bool isItem = false;

            this.Pub1.AddTable("class='Table' cellpadding='0' cellspacing='0' border='0' style='width:100%'");
            this.Pub1.AddCaptionLeft("为字段[" + this.RefNo + "]设置pop返回值" + BP.WF.Glo.GenerHelpCCForm("设置pop返回值", "http://ccform.mydoc.io/?v=5769&t=20182", ""));
        ...
        void btn_SavePopVal_Click(object sender, EventArgs e)
        {
            ...
            RadioButton rb = this.Pub1.GetRadioButtonByID("RB_Tag_0");
            if (rb.Checked)
