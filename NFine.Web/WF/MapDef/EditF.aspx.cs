    ...
    public partial class Comm_MapDef_EditF : BP.Web.WebPage
    {
        ...
        public void EditBeforeEnd(MapAttr mapAttr)
        {
            ...
            if (this.RefNo != null)
            {
                ...
                html += " - <a href=\"javascript:WinOpen('./MapExt/TBFullCtrl.aspx?FK_MapData=" + mapAttr.FK_MapData + "&RefNo=" + mapAttr.KeyOfEn + "&MyPK="+MapExtXmlList.TBFullCtrl+"_"+mapAttr.MyPK+"')\">文本框自动完成</a>";
                ...
                this.Pub1.AddTD("<a href=\"javascript:WinOpen('./MapExt/AutoFull.aspx?FK_MapData=" + mapAttr.FK_MapData + "&ExtType=AutoFull&RefNo=" + mapAttr.MyPK + "')\">获取外部数据</a>");
                this.Pub1.AddTREnd();
            }
            #endregion pop返回值.
