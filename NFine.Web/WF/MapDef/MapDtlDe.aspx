...
<head id="Head1" runat="server">
    ...
    <script language="javascript">
        ...
        function Attachment(fk_mapdtl) {
            window.showModalDialog('Attachment.aspx?IsBTitle=1&PKVal=0&FK_MapData=' + fk_mapdtl + '&FK_FrmAttachment=' + fk_mapdtl + '_AthM&Ath=AthM&s=' + Math.random());
        }
        function MapM2M(fk_mapdtl) {
            window.showModalDialog('MapM2M.aspx?NoOfObj=M2M&PKVal=0&FK_MapData=' + fk_mapdtl + '&FK_FrmAttachment=' + fk_mapdtl + '_AthM&Ath=AthM&s=' + Math.random());
        }
    </script>
