<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CCFlow.WF.Admin.BPMN.Login" %>
    ...
    <div class="container">
        <section id="content">
		 <form action="Login.aspx?DoType=Login" runat="server">
			<h1><span style="color:Red;">CC</span><span style="color:Blue;">BPM</span>设计器</h1>
			<div>
				<input runat="server" type="text" placeholder="用户名" required="" class="username" id="TB_UserName" />
			</div>
			<div>
