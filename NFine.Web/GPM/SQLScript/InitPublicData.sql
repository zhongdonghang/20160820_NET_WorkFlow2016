...
INSERT INTO SYS_GloVar(No,Name,DefVal,GroupKey,Note) VALUES ('ColsOfApp','SSO界面应用系统列数','2','APP','SSO界面应用系统列数。');
INSERT INTO SYS_GloVar(No,Name,DefVal,GroupKey,Note) VALUES ('ColsOfSSO','SSO界面信息列数','3','SSO','SSO界面信息列数,单点登陆界面中的列数。');
INSERT INTO SYS_GloVar(No,Name,DefVal,GroupKey,Note) VALUES ('UnitFullName','单位全称','济南驰骋信息技术有限公司','Glo','');
INSERT INTO SYS_GloVar(No,Name,DefVal,GroupKey,Note) VALUES ('UnitSimpleName','单位简称','驰骋软件','Glo','');
